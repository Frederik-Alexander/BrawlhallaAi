...
model_weights_path = 'C:/Users/Ai/Desktop/Brawlhalla Supervised/Autoencoder_weights.h5'

class Autoencoder:
    def __init__(self, input_shape, encoded_dim, learning_rate, load_Model):
        ...
        print ("shape of LAYER", K.int_shape(x))
        #x = MaxPooling2D((2, 2), padding='same')(x)
        self.encoded = Conv2D(8, (2, 2), activation='relu', padding='same')(x)
        #self.encoded = MaxPooling2D((2, 2), padding='same')(x)


        #at this point the representation is ... 50*50*4
        x = Conv2D(8, (2, 2), activation='relu', padding='same')(self.encoded)
        print ("shape of LAYER", K.int_shape(x))
        ...
        self.encoderonly = Model(input_img, self.encoded)
    ...
    def train(self, x_train, x_test, history, epochs=2, batch_size=20, shuffle=True ):
        ...
        self.autoencoder.fit(x_train, x_train,
                ...
                callbacks=[TensorBoard(log_dir='C:/Users/Ai/Desktop/Brawlhalla Supervised/TENSORBOARD')])
